...
<Tabs>
    <Tab title="Dashboard">
        ...
        ```bash
        curl --request GET --url 'https://api.example.com/scraper?api_key=YOUR_API_KEY&workflow_id=cm1zwux5s000012i655qokya5'
        ```
        ...
        ```bash
        curl "https://api.example.com/workflow/?api_key=YOUR_API_KEY"
        ```
        ...
        ```bash
        curl "https://api.example.com/workflow/requests/${requestId}/?api_key=YOUR_API_KEY"
        ```
    ...
    <Tab title="API">
        ...
        ```bash
        https://api.example.com/workflow/create/?api_key=YOUR_API_KEY
        ```
        ...
        ```bash
        curl -X POST "https://api.example.com/workflow/create/?api_key=YOUR_API_KEY" \
        ...
        ```bash
        curl -X DELETE "https://api.example.com/workflow/archive/${workflowId}?api_key=YOUR_API_KEY"
        ```
        ...
        ```bash
        curl -X POST "https://api.example.com/workflow/unarchive/${workflowId}?api_key=YOUR_API_KEY"
        ```
        ...
        ```bash
        curl -X PATCH "https://api.example.com/workflow/edit/${workflowId}?api_key=YOUR_API_KEY" \
            -H "Content-Type: application/json" \
            -d '{
                "name": "Updated name",
                "config": {
