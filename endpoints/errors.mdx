...
import StatusCodeTable from '@site/src/components/statusCodes';
...
```http
GET 'https://api.scrapeautomate.com/api/scraper?api_key=[OPTIONS]'
...
Below is a table of common error codes and their descriptions:
