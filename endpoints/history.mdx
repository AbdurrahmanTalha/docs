...
```
https://api.scrapeautomate.com/api/requests?api_key=1cbf2a99-ef94-4255-aae9-fdbfdcff3b53
```
  ...
  "requests": [
    {
      ...
      "statusCode": "200",
      "message": "Request has been sent to https://api.scrapeautomate.com/api/scraper?api_key=1cbf2a99-ef94-4255-aae9-fdbfdcff3b53&render=true&url=https:%2F%2Fexample.com%2F&url=https://example.com/",
      "url": "https://api.scrapeautomate.com/api/scraper?api_key=1cbf2a99-ef94-4255-aae9-fdbfdcff3b53&render=true&url=https:%2F%2Fexample.com%2F&url=https://example.com/",
      "creditCost": 10,
...
```
https://api.scrapeautomate.com/api/requests?api_key=1cbf2a99-ef94-4255-aae9-fdbfdcff3b53&page=2
```
...
```
https://api.scrapeautomate.com/api/requests?api_key=1cbf2a99-ef94-4255-aae9-fdbfdcff3b53&page=1&limit=100
```
...
```
https://api.scrapeautomate.com/api/requests/${requestId}?api_key=1cbf2a99-ef94-4255-aae9-fdbfdcff3b53
```
