...
```bash
curl --request GET \
  --url 'https://api.example.com/scraper?api_key=<exampleTOken>&render=false&url=https%3A%2F%2Fexample.com%2F'
```
...
```bash
curl --request GET \
  --url 'https://api.example.com/scraper?url=https%3A%2F%2Fexample.com%2F&api_key=<exampleTOken>&markdown=true'
```
...
```bash
curl --request GET \
  --url 'https://api.example.com/scraper?api_key=<exampleTOken>&render=true&url=https%3A%2F%2Fexample.com%2F&screenshot=true'
```
...
```bash
curl --request GET \
  --url 'https://api.example.com/scraper?api_key=<exampleTOken>&render=true&url=https%3A%2F%2Fexample.com%2F&screenshot_full_page=true'
```
