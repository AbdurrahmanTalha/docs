...
```bash
curl --request GET \
--url 'https://api.scrapeautomate.com/scraper?api_key=YOUR_API_KEY&render=false&url=https%3A%2F%2Fexample.com%2F&proxy_type=residential'
```
...
```bash
curl --request GET \
--url 'https://api.scrapeautomate.com/scraper?api_key=YOUR_API_KEY&render=false&url=https%3A%2F%2Fexample.com%2F&proxy_country=jp'
```
